...
#define PROCESSES 4         // 3 processes(change)
#define MAIN_MEMORY_SIZE 32 // 32 addresable locations in main memory
#define RESET_INTERVAL 200  // Reset intexrval for PER algorithm
...
/**
 * function to reset reference bits of all pages in the main memory for PER algorithm
 */
void reset_ref_bits();
/**
...
/**
 * function to give next available physical page in main memory
